...
class TestCategory(object):
    def __init__(self, login): #要传入login,所有的过程都是在登录的基础上
        self.login = login
    ...
    def test_add_category_error(self):
        ...
        loc = (By.CLASS_NAME, 'toast-message') #元组

        WebDriverWait(self.login.driver, 5).until(EC.visibility_of_element_located(loc))#等待直到toast:message出现
